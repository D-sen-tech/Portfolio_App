...
public class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.MenuViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MenuViewHolder holder, int position) {
        ...
        if (mData.get(position).isSelected()){
            holder.isSeleected.setVisibility(View.VISIBLE);
        }
        else
            holder.isSeleected.setVisibility(View.GONE);
    ...
    public class MenuViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView icon,isSeleected;

        public MenuViewHolder(@NonNull View itemView) {
            super(itemView);

            icon = itemView.findViewById(R.id.item_menu_icon);
            isSeleected = itemView.findViewById(R.id.item_menu_selected);
